...
#:endif
      ...
      REKS_SCC: if (allocated(this%reks)) then
         ...
         lpSCC_REKS: do iSccIter = 1, this%maxSccIter
            ...
            & this%solvation, this%openmmpolCalc, this%thirdOrd, this%potential, this%hybridXc,&
            & this%nNeighbourCam, this%nNeighbourCamSym, this%tDualSpinOrbit, this%xi,&
            & this%isExtField, this%isXlbomd, this%dftbU, this%dftbEnergy(1)%TS,&
            & this%qDepExtPot, this%qBlockOut, this%qiBlockOut, this%tFixEf,&
            & this%Ef, this%rhoPrim, this%onSiteElements, this%dispersion,&
            & tConverged, this%species0, this%referenceN0, this%qNetAtom,&
            & this%multipoleOut, this%reks, errStatus)
            @:PROPAGATE_ERROR(errStatus)
         ...
         lpSCC: do iSccIter = 1, this%maxSccIter
            ...
            lpConstrInner: do iConstrIter = 1, nConstrIter
               ...
               & this%openmmpolCalc, this%hybridXc, this%reks, this%qDepExtPot,&
               & this%qBlockOut, this%qiBlockOut, this%xi, this%iAtInCentralRegion,&
               & this%tFixEf, this%Ef, this%tRealHS, this%onSiteElements,&
               & errStatus, qNetAtom=this%qNetAtom,&
...
#:endif
   ...
   & cellVol, extPressure, energy, q0, iAtInCentralRegion, solvation, openmmpolCalc,&
   & thirdOrd, potential, hybridXc, nNeighbourCam, nNeighbourCamSym, tDualSpinOrbit,&
   & xi, isExtField, isXlbomd, dftbU, TS, qDepExtPot, qBlock, qiBlock, tFixEf, Ef,&
   & rhoPrim, onSiteElements, dispersion, tConverged, species0, referenceN0,&
   & qNetAtom, multipole, reks, errStatus)
...
#:endif
      ...
      do iL = 1, reks%Lmax
         ...
         & openmmpolCalc, hybridXc, reks, qDepExtPot, qBlock, qiBlock, xi,&
