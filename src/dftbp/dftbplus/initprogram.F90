  ...
  #:endif
    ...
    if (allocated(input%ctrl%openmmpolInput)) then
      ...
      if (allocated(input%ctrl%hybridXcInp)) then
        call error("Hybrid and range-separated calculations with openmmpol are not yet implemented.")
      end if
  ...
  #:endif
    ...
    if (this%isElecDyn) then
      ...
      call TElecDynamics_init(this%electronDynamics, input%ctrl%elecDynInp, this%species0,&
          ...
          & this%dispersion, this%openmmpolCalc, this%nonSccDeriv, this%tPeriodic,&
          & this%parallelKS, this%tRealHS, this%kPoint, this%kWeight, this%isHybridXc,&
