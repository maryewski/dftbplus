...
contains
  ...
  subroutine TElecDynamics_init(this, inp, species, speciesName, tWriteAutotest, autotestTag,&
      & randomThermostat, mass, nAtom, skCutoff, mCutoff, atomEigVal, dispersion, openmmpolCalc,&
      & nonSccDeriv, tPeriodic, parallelKS, tRealHS, kPoint, kWeight, isHybridXc, sccCalc, tblite,&
  ...
  subroutine updateH(this, H1, ints, H0, speciesAll, qq, q0, coord, orb, potential,&
      ...
      & deltaRho, H1LC, Ssqr, solvation, openmmpolCalc, hybridXc, dispersion, rho, errStatus)
  ...
  subroutine getTDEnergy(this, env, energy, rhoPrim, rho, neighbourList, nNeighbourSK, orb,&
    ...
    call calcEnergies(env, this%sccCalc, this%tblite, qq, q0, chargePerShell, this%multipole,&
        ...
        & potential, energy, thirdOrd, solvation, this%openmmpolCalc, hybridXc, reks, &
        & qDepExtPot, qBlock, qiBlock, xi, iAtInCentralRegion, tFixEf, Ef, .true., &
        & onSiteElements, errStatus)
    @:PROPAGATE_ERROR(errStatus)
  ...
  subroutine initializeDynamics(this, boundaryCond, coord, orb, neighbourList, nNeighbourSK,&
    ...
    call updateH(this, this%H1, ints, this%ham0, this%speciesAll, this%qq, q0, coord, orb,&
        ...
        & onSiteElements, refExtPot, this%deltaRho, this%H1LC, this%Ssqr, solvation,&
        & this%openmmpolCalc, hybridXc, this%dispersion, this%trho, errStatus)
    @:PROPAGATE_ERROR(errStatus)
    ...
    call updateH(this, this%H1, ints, this%ham0, this%speciesAll, this%qq, q0, coord, orb,&
        ...
        & this%chargePerShell, spinW, env, tDualSpinOrbit, xi, thirdOrd, this%qBlock, dftbU,&
        & onSiteElements, refExtPot, this%deltaRho, this%H1LC, this%Ssqr, solvation, &
        & this%openmmpolCalc, hybridXc, this%dispersion,this%rho, errStatus)
    @:PROPAGATE_ERROR(errStatus)
